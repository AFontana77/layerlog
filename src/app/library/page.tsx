...
export const metadata: Metadata = {
  title: "LayerLog Library — 2,000+ filaments",
  description: "Filaments from 100+ brands — print temp, bed temp, cooling, retraction, and known issues. Browse the LayerLog reference database — available in the free app.",
};
        ...
        <section className="py-16 px-4" style={{ backgroundColor: '#F5F3FF' }}>
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-gray-600 text-lg max-w-xl mx-auto leading-relaxed">
              2,000+ filaments from Filamentpedia + manufacturer datasheets. Filaments from 100+ brands — print temp, bed temp, cooling, retraction, and known issues.
            </p>
        ...
        <section className="py-16 px-4 bg-violet-50">
          <div className="max-w-2xl mx-auto text-center">
            ...
            <p className="text-gray-600 mb-6">
              The LayerLog app has the complete 2,000+ filaments with full-text search, filters, and your personal log — all free.
            </p>
