        ...
        <section className="py-20 px-4" style={{ backgroundColor: '#F5F3FF' }}>
          <div className="max-w-3xl mx-auto text-center">
            <span className="inline-block text-xs font-semibold uppercase tracking-widest text-violet-700 bg-violet-50 px-3 py-1 rounded-full mb-6">
              Search 2,000+ filaments. Log your own.
            </span>
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-gray-900 leading-tight mb-6">
              Search 2,000+ filaments.
              <br />
              <span className="text-violet-800">Log your prints.</span>
            </h1>
            <p className="text-lg text-gray-600 max-w-2xl mx-auto mb-8 leading-relaxed">
              LayerLog brings a curated filament database to every print session. Search PLA, PETG, TPU, ABS, ASA, and specialty materials by brand, temp range, and print characteristics. Log your actual settings for every print — what worked, what didn't, and why. Stop printing from memory.
            </p>
            <div className="flex flex-col sm:flex-row gap-3 justify-center">
              <Link href="/library" className="inline-flex items-center justify-center gap-2 bg-violet-700 text-white font-semibold px-8 py-3 rounded-xl hover:bg-violet-800 transition-colors press-feedback min-h-[48px]">
                Browse the LayerLog Library <ArrowRight size={18} />
              </Link>
            ...
            <p className="mt-4 text-sm text-gray-400">
              Free app. No credit card. 2,000+ filaments from Filamentpedia + manufacturer datasheets.
            </p>
          </div>
        </section>
        ...
        <section className="py-16 px-4 bg-white">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-gray-600 max-w-2xl mx-auto mb-10 leading-relaxed">
              Most log apps give you a blank screen. LayerLog gives you 2,000+ filaments from Filamentpedia + manufacturer datasheets — searchable, organized, and ready to use. Log what you do. Build your personal collection alongside the reference library.
            </p>
